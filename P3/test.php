<?php
$bdd = new PDO("mysql:host=127.0.0.1;dbname=gbaf;charset=utf8", "root", "");
$banque = $bdd->query('SELECT * FROM banque ORDER BY id DESC');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
   <ul>
      <?php while($a = $banque->fetch()) { ?>
      
      <li><?= $a['nom'] ?></a></li><?php  ?>
      <li><?= $a['description'] ?></a></li><?php } ?>
